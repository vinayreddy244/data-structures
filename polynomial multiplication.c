...
void main()
{
	...
	{
		printf("\n******* MAIN MENU *******");
		printf("\nenter 1. Enter the first polynomial");
		printf("\nenter 2. Display the first polynomial");
 		printf("\nenter 3. Enter the second polynomial");
 		printf("\nenter 4. Display the second polynomial");
 		printf("\nenter 5. multiply the polynomials");
 		printf("\nenter 6. Display the multiplication result");
 		printf("\nenter 7. Add the coefficients of same exponents");
 		printf("\nenter 8. Display the final result");
		printf("\nenter 9. EXIT");
 		printf("\n\n Enter your option : ");
 		scanf("%d", &option);
		switch(option)
...
// this function is used to add the node of the multiply result to the 
