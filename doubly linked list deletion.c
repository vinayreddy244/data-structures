/* c program perform operations on doubly linked list */
#include<stdio.h>
#include<stdlib.h>
struct node
{
...
void main()
{
	...
	{
		printf("\n\n ***** MAIN MENU *****");
		printf("\nenter 1: cearte a list");
		printf("\nenter 2: Display a list");
		printf("\nenter 3: Delete a node from the beginning");
 		printf("\nenter 4: Delete a node from the end");
		printf("\nenter 5: Delete a node after a given node");
		printf("\nenter 6: Exit");
		printf("\n\n Enter your option: ");
		scanf("%d",&option);
		switch(option)
